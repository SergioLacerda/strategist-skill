...
| `critical-hit.yaml` | — | `.strategist/contracts/machine/critical-hit.yaml` | **UNPARSEABLE**: mapping values are not allowed here in ".strategist/contracts/machine/critical-hit.yaml", line 138, column 96 | — | — | — | — |
...
| `handoff-contract.yaml` | — | `.strategist/contracts/machine/handoff-contract.yaml` | **UNPARSEABLE**: mapping values are not allowed here in ".strategist/contracts/machine/handoff-contract.yaml", line 97, column 21 | — | — | — | — |
...
| `mission-status` | canonical_vocabulary | `.strategist/contracts/machine/mission-status.yaml` | Single normative list of every value the `mission_status` frontmatter field (set on the mission analysis artifact — see schemas/handoff-ranger-to-archivist.s... | — | — | — | — |
...
| `scout-routing` | routing_decision | `.strategist/contracts/machine/scout-routing.yaml` | Machine contract for Scout, the internal pre-pipeline Intake Router. Scout classifies each request immediately after intake and selects one of critical_hit, ... | — | — | — | — |
