...
var metricsRolloutCmd = &cobra.Command{
	Use:   "rollout-check",
...
func init() {
	...
	requireFlags(metricsRolloutCmd, "enforcement")
	metricsRolloutCmd.RunE = func(cmd *cobra.Command, _ []string) error {
		return runMetricsRollout(cmd, opts)
	}
	metricsCmd.AddCommand(metricsRolloutCmd)
}
