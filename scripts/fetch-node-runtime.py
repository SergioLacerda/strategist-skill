...
"""
import gzip, hashlib, io, os, platform, sys, tarfile, urllib.request, zipfile
import yaml
...
def build(target: str, lock: dict) -> None:
    ...
    open(os.path.join(out_dir, "node.info.yaml"), "w").write(
        "# Generated by scripts/fetch-node-runtime.py - do not edit.\n" + yaml.safe_dump(info, sort_keys=True))
