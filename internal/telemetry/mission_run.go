...
// MarkIntake, MarkScout, MarkRanger, MarkArchivist, MarkGatePresented,
// MarkGateResponse, MarkSniper, and markTimeOnce live in
// mission_run_marks.go, split out to keep this file under the repo's
// file-size budget.
